...
// Fri Jun 25 16:25:55 2021 by ROOT version 6.24/00
// from TTree event_tree/event tree
// found on file: Nu_e-rtd-39.root
//////////////////////////////////////////////////////////

#ifndef SemiAnalytic_v03_06_25_21_h
#define SemiAnalytic_v03_06_25_21_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   vector<int>     *pixel_x;
   vector<int>     *pixel_y;
   vector<vector<double> > *pixel_reset;
   vector<vector<double> > *pixel_tslr;
   ...
   TBranch        *b_pixel_x;   //!
   TBranch        *b_pixel_y;   //!
   TBranch        *b_pixel_reset;   //!
   TBranch        *b_pixel_tslr;   //!

   SemiAnalytic_v03_06_25_21(TTree *tree=0);
   virtual ~SemiAnalytic_v03_06_25_21();
...
#ifdef SemiAnalytic_v03_06_25_21_cxx
SemiAnalytic_v03_06_25_21::SemiAnalytic_v03_06_25_21(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("Nu_e-rtd-39.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("Nu_e-rtd-39.root");
      }
...
SemiAnalytic_v03_06_25_21::~SemiAnalytic_v03_06_25_21()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t SemiAnalytic_v03_06_25_21::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t SemiAnalytic_v03_06_25_21::LoadTree(Long64_t entry)
{
...
void SemiAnalytic_v03_06_25_21::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("pixel_x", &pixel_x, &b_pixel_x);
   fChain->SetBranchAddress("pixel_y", &pixel_y, &b_pixel_y);
   fChain->SetBranchAddress("pixel_reset", &pixel_reset, &b_pixel_reset);
   fChain->SetBranchAddress("pixel_tslr", &pixel_tslr, &b_pixel_tslr);
   Notify();
}

Bool_t SemiAnalytic_v03_06_25_21::Notify()
{
...
void SemiAnalytic_v03_06_25_21::Show(Long64_t entry)
{
...
Int_t SemiAnalytic_v03_06_25_21::Cut(Long64_t entry)
{
...
#endif // #ifdef SemiAnalytic_v03_06_25_21_cxx
