...
// ================================================================================================
TH2D *hEnergyDepositedVSPhotons = new TH2D("hEnergyDepositedVSPhotons", "Energy Deposited vs # of Photons", 200, 0, 200, 1000, 0, 10000);
...
TH2D *hyizi = new TH2D("hyizi", "hyizi", 600, 0, 600, 600, 0, 600);
TH2D *hxiyi = new TH2D("hxiyi", "hxiyi", 350, 0, 350, 600, 0, 600);
TH2D *hxizi = new TH2D("hxizi", "hxizi", 350, 0, 350, 600, 0, 600);

TH2D *YprimaryZPrimary = new TH2D("YprimaryZPrimary", "YprimaryZPrimary", 600, 0, 600, 600, 0, 600);
TH2D *XprimaryYPrimary = new TH2D("XprimaryYPrimary", "XprimaryYPrimary", 350, 0, 350, 600, 0, 600);
TH2D *XprimaryZPrimary = new TH2D("XprimaryZPrimary", "XprimaryZPrimary", 350, 0, 350, 600, 0, 600); 
// ================================================================================================  
// ================================================================================================
...
{
std::string Files = "./SemiAnalytic-MarleyEvents_Event";
...
//for (Long64_t jentry=Event; jentry<Event_plus_one;jentry++) 
   ...
   double xoffset = gRandom->Uniform(-10,10);
   double yoffset = gRandom->Uniform(-10,10);
   double zoffset = gRandom->Uniform(-10,10);
   ...
   for (int Edep = 0; Edep < number_hits; Edep ++)
	...
	hXPos->Fill(xpos);
        ...
        // ### For MARLEY events, I need to subtract the supernova time structure
        // ### in order to see anything, in the time ordered plots
        double t0 = hit_start_t->at(0);

	// ### Grab the deposition time as recored by Geant4 ###
        // ### note: I'm subtracting t0 to get something sensible
	double DepositionTime = hit_start_t->at(Edep) - t0;

        //std::cout<<"DepositionTime = "<<DepositionTime<<std::endl;
